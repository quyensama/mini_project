<div class="panel panel-default">
    ...
    <div class="list-group">
        ...
        <div class="form-group list-group-item">
            ...
            <textarea class="form-control" name="content" style="height:110px; display: table-cell;"><?php echo stripcslashes($data["content"]['value']); ?></textarea>
        </div>
        <div class="form-group list-group-item">
        ...
        <div class="form-group list-group-item">
            <label for="keyword">Từ Khóa, Tags (cách nhau bằng dâu ,)</label>
       ...
       <div class="form-group list-group-item">
            <input type="hidden" name="author" value="<?php echo empty($data["id_author"]['value']) ? $_SESSION['id'] : $data["id_author"]['value'] ?>">
            <input class="btn btn-primary" type="submit" name="save" value="Đăng Bài">
        </div>
        </form>
    </div>
</div>
